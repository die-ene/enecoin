...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 1.2 * COIN; // 120%
static const int64_t COIN_YEAR_REWARD = 12.0 * CENT; // 120%
...
static const uint256 hashGenesisBlock("0x0000092576d4250c9ead23e9f03c2d4d9ba02301009158b84477b041ba8245cb");
static const uint256 hashGenesisBlockTestNet("0x00009a59606f228b1c905c89aaa189d17e7668f5380b3f01602027ed6c48f5a6");

inline int64_t PastDrift(int64_t nTime)   { return nTime - 4 * 60; } // up to 10 minutes from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 4 * 60; } // up to 10 minutes from the future
